...
local function ImpoundBlips(coords, type, label, blipOptions)
    ...
    SetBlipColour(blip, blipOptions?.colour and blipOptions.colour or type == 'car' and Config.BlipColors.Car or type == 'boat' and Config.BlipColors.Boat or Config.BlipColors.Aircraft or type == 'helicopter')
...
local function GarageBlips(coords, type, label, job, blipOptions)
    ...
    SetBlipScale(blip, blipOptions?.scale or 0.8)
    SetBlipColour(blip, blipOptions?.colour ~= nil and blipOptions.colour or type == 'car' and Config.BlipColors.Car or type == 'boat' and Config.BlipColors.Boat or Config.BlipColors.Aircraft or type == 'helicopter')
    SetBlipAsShortRange(blip, true)
    BeginTextCommandSetBlipName("STRING")
...
local function JobGarageBlip(garage)
    ...
    SetBlipColour(jobBlips[index], garage.type == 'car' and Config.BlipColors.Car or garage.type == 'boat' and Config.BlipColors.Boat or Config.BlipColors.Aircraft or type == 'helicopter')
